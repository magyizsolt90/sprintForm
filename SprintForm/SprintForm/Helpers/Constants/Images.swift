...
struct Images {
    ...
    static let financial =      UIImage(systemName: "chart.pie.fill")!
    static let lifestyle =      UIImage(systemName: "figure.run")!
    static let entertainment =  UIImage(systemName: "party.popper.fill")!
    static let miscellaneous =  UIImage(systemName: "number")!
}
